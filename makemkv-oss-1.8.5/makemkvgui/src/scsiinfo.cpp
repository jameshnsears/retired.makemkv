...
bool FormatDriveDiskInfo(QString& ProtectionString,QString& FullInfoString,const utf16_t* DeviceNameString,const void* DiskData,unsigned int DiskDataSize,AP_DiskFsFlags FsFlags,AP_DriveState DriveState)
{
    struct _items{
        ...
        DriveInfoItem   svm_small,aacs,ccert_small,aacs_high;
    } items;
