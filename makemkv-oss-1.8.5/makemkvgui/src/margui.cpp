...
bool CGUIApClient::OpenFile(const utf16_t* FileName)
{
...
bool CGUIApClient::OpenTitleCollection(const utf16_t* Source)
{
...
bool CGUIApClient::OpenCdDisk(unsigned int Id)
{
    m_mem->args[0]=Id;
